import { forward, precomputeWteT } from "./model";
import { initScratch } from "./scratch";

export function dataPtr(arr: Float32Array): usize { return arr.dataStart; }
export function newF32(length: i32): Float32Array  { return new Float32Array(length); }
export function newI32(length: i32): Int32Array    { return new Int32Array(length); }
export function i32DataPtr(arr: Int32Array): usize { return arr.dataStart; }

// JS wywołuje initScratch(maxSeq) raz przed pierwszym forward
export { initScratch };
...
// wywołaj po initWeights — transponuje wte do scratch.wteT raz
export function computeWteT(): void {
  precomputeWteT(g_wte);
}
